...
//  *
//  * This program shows various ways to use the registry:
//  * 1. Listing all registered handlers (introspection)
//  * 2. Executing handlers by name using the convenience method
//  * 3. Manually instantiating and executing handlers (more control)
//  * 4. Handling non-existent handlers gracefully (error handling)
//  *
//  * Educational Note:
//  * - By the time main() starts, all handlers are already registered
//  * - Static initialization has completed for all translation units
//  * - No handler objects are created until explicitly instantiated
//  * - The registry acts as a service locator for command handlers
//  * - This pattern is commonly used in: plugin architectures, game engines,
//  *   command-line tools, event-driven systems, and microservices
//  */
// int main() {

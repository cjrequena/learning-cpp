...
//  These specifiers precede the type that they modify. There are following storage classes, which can be used in a C++
//  Program
//  - auto
//  - register
//  - static
...
StorageClasses::StorageClasses() {
  cout << "\n" << endl;
  cout << "================================" << endl;
  cout << "StorageClasses Constructor Called." << endl;
  cout << "================================" << endl;
}
...
StorageClasses::~StorageClasses() {
  cout << "\n" << endl;
  cout << "================================" << endl;
  cout << "StorageClasses Destructor Called." << endl;
  cout << "================================" << endl;
}